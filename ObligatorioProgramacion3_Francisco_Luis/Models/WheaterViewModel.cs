...
namespace ObligatorioProgramacion3_Francisco_Luis.Models
{
    public partial class WeatherViewModel
    {
        ...
        // Método FromJson movido aquí
        public static WeatherViewModel FromJson(string json) => JsonConvert.DeserializeObject<WeatherViewModel>(json, WeatherConverter.Settings);
    }
    ...
    {
        public static string ToJson(this WeatherViewModel self) => JsonConvert.SerializeObject(self, WeatherConverter.Settings);
    }
